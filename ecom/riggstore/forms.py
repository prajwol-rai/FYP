...
from .models import Customer, Community, GameScreenshot, Post, GameSubmission  # Updated imports
...
from .models import GameSubmission
...
class GameUploadForm(forms.ModelForm):
    # Add screenshots field explicitly
    ...
    def save(self, commit=True):
        ...
        # Save screenshots after instance has an ID
        if 'screenshots' in self.files:
            for file in self.files.getlist('screenshots'):
                GameScreenshot.objects.create(game=instance, image=file)
